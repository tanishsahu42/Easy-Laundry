...
function updateCart(clothes) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', clothes).then(function (res) {
...
addtoCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var clothes = JSON.parse(btn.dataset.clothes);
    updateCart(clothes);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunklaundry"] = self["webpackChunklaundry"] || [];
